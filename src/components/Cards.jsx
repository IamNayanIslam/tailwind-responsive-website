  ...
  return (
    <div className="w-full bg-white px-4">
        <div className="md:max-w-screen-lg mx-auto text-black flex flex-col md:flex-row md:justify-between py-[100px]">
            <div className="shadow-xl flex flex-col items-center p-4 w-[32%] my-4 rounded-lg hover:scale-105 hover:bg-gray-300 ease-in-out duration-300">
            ...
            <div className="shadow-xl  flex flex-col items-center w-[32%] p-4 my-4 rounded-lg hover:scale-105 hover:bg-gray-300 ease-in-out duration-300">
